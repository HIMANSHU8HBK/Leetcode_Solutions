## Problem: [303. Range Sum Query - Immutable](https://leetcode.com/problems/range-sum-query-immutable/) - Easy
```python
class NumArray:
...
## Problem: [724. Find Pivot Index](https://leetcode.com/problems/find-pivot-index/) - Easy
```python
class Solution:
...
## Problem: [1480. Running Sum of 1d Array](https://leetcode.com/problems/running-sum-of-1d-array/) - Easy
```python
class Solution:
...
## Problem: [1732. Find the Highest Altitude](https://leetcode.com/problems/find-the-highest-altitude/) - Easy
```python
class Solution:
...
## Problem: [1991. Find the Middle Index in Array](https://leetcode.com/problems/find-the-middle-index-in-array/) - Easy
```python
class Solution:
...
## Problem: [2389. Longest Subsequence With Limited Sum](https://leetcode.com/problems/longest-subsequence-with-limited-sum/) - Easy
```python
...
## Problem: [560. Subarray Sum Equals K](https://leetcode.com/problems/subarray-sum-equals-k/) - Medium
```python
class Solution:
...
## Problem: [523. Continuous Subarray Sum](https://leetcode.com/problems/continuous-subarray-sum/) - Medium
```python
class Solution:
...
## Problem: [525. Contiguous Array](https://leetcode.com/problems/contiguous-array/) - Medium
```python
class Solution:
...
## Problem: [930. Binary Subarrays With Sum](https://leetcode.com/problems/binary-subarrays-with-sum/) - Medium
```python
class Solution:
...
## Problem: [974. Subarray Sums Divisible by K](https://leetcode.com/problems/subarray-sums-divisible-by-k/) - Medium
```python
...
## Problem: [1248. Count Number of Nice Subarrays](https://leetcode.com/problems/count-number-of-nice-subarrays/) - Medium
```python
class Solution:
...
## Problem: [1590. Make Sum Divisible by P](https://leetcode.com/problems/make-sum-divisible-by-p/) - Medium
```python
class Solution:
...
## Problem: [1124. Longest Well-Performing Interval](https://leetcode.com/problems/longest-well-performing-interval/) - Medium
```python
class Solution:
...
## Problem: [1442. Count Triplets That Can Form Two Arrays of Equal XOR](https://leetcode.com/problems/count-triplets-that-can-form-two-arrays-of-equal-xor/) - Medium
```python
class Solution:
...
## Problem: [1524. Number of Sub-arrays With Odd Sum](https://leetcode.com/problems/number-of-sub-arrays-with-odd-sum/) - Medium
```python
class Solution:
...
## Problem: [304. Range Sum Query 2D - Immutable](https://leetcode.com/problems/range-sum-query-2d-immutable/) - Medium
```python
class NumMatrix:
...
## Problem: [1314. Matrix Block Sum](https://leetcode.com/problems/matrix-block-sum/) - Medium
```python
class Solution:
...
## Problem: [1074. Number of Submatrices That Sum to Target](https://leetcode.com/problems/number-of-submatrices-that-sum-to-target/) - Hard
```python
from collections import defaultdict
class Solution:
...
## Problem: [1109. Corporate Flight Bookings](https://leetcode.com/problems/corporate-flight-bookings/) - Medium
```python
class Solution:
...
## Problem: [1854. Maximum Population Year](https://leetcode.com/problems/maximum-population-year/) - Easy
```python
class Solution:
...
## Problem: [1893. Check if All the Integers in a Range Are Covered](https://leetcode.com/problems/check-if-all-the-integers-in-a-range-are-covered/) - Easy
```python
class Solution:
...
## Problem: [437. Path Sum III](https://leetcode.com/problems/path-sum-iii/) - Medium
```python
from collections import defaultdict
class Solution:
...
## Problem: [1589. Maximum Sum Obtained of Any Permutation](https://leetcode.com/problems/maximum-sum-obtained-of-any-permutation/) - Medium
```python
class Solution:
...
## Problem: [1594. Maximum Non Negative Product in a Matrix](https://leetcode.com/problems/maximum-non-negative-product-in-a-matrix/) - Medium
```python
class Solution:
...
## Problem: [862. Shortest Subarray with Sum at Least K](https://leetcode.com/problems/shortest-subarray-with-sum-at-least-k/) - Hard
```python
...
## Problem: [77. Combinations](https://leetcode.com/problems/combinations/) - Medium
```python
class Solution:
...
## Problem: [78. Subsets](https://leetcode.com/problems/subsets/) - Medium
```python
class Solution:
...
## Problem: [90. Subsets II](https://leetcode.com/problems/subsets-ii/) - Medium
```python
class Solution:
...
## Problem: [39. Combination Sum](https://leetcode.com/problems/combination-sum/) - Medium
```python
class Solution:
...
## Problem: [40. Combination Sum II](https://leetcode.com/problems/combination-sum-ii/) - Medium
```python
class Solution:
...
## Problem: [216. Combination Sum III](https://leetcode.com/problems/combination-sum-iii/) - Medium
```python
class Solution:
...
## Problem: [46. Permutations](https://leetcode.com/problems/permutations/) - Medium
```python
class Solution:
...
## Problem: [47. Permutations II](https://leetcode.com/problems/permutations-ii/) - Medium
```python
class Solution:
...
## Problem: [60. Permutation Sequence](https://leetcode.com/problems/permutation-sequence/) - Hard
```python
import math
class Solution:
...
## Problem: [17. Letter Combinations of a Phone Number](https://leetcode.com/problems/letter-combinations-of-a-phone-number/) - Medium
```python
class Solution:
...
## Problem: [22. Generate Parentheses](https://leetcode.com/problems/generate-parentheses/) - Medium
```python
class Solution:
...
## Problem: [131. Palindrome Partitioning](https://leetcode.com/problems/palindrome-partitioning/) - Medium
```python
class Solution:
...
## Problem: [93. Restore IP Addresses](https://leetcode.com/problems/restore-ip-addresses/) - Medium
```python
class Solution:
...
## Problem: [140. Word Break II](https://leetcode.com/problems/word-break-ii/) - Hard
```python
...
## Problem: [37. Sudoku Solver](https://leetcode.com/problems/sudoku-solver/) - Hard
```python
class Solution:
...
## Problem: [51. N-Queens](https://leetcode.com/problems/n-queens/) - Hard
```python
class Solution:
...
## Problem: [52. N-Queens II](https://leetcode.com/problems/n-queens-ii/) - Hard
```python
class Solution:
...
## Problem: [79. Word Search](https://leetcode.com/problems/word-search/) - Medium
```python
class Solution:
...
## Problem: [980. Unique Paths III](https://leetcode.com/problems/unique-paths-iii/) - Hard
```python
class Solution:
...
## Problem: [1255. Maximum Score Words Formed by Letters](https://leetcode.com/problems/maximum-score-words-formed-by-letters/) - Hard
```python
...
## Problem: [212. Word Search II](https://leetcode.com/problems/word-search-ii/) - Hard
```python
class TrieNode:
    def __init__(self):
        self.children = {}
...
## Problem: [282. Expression Add Operators](https://leetcode.com/problems/expression-add-operators/) - Hard
```python
class Solution:
...
## Problem: [31. Next Permutation](https://leetcode.com/problems/next-permutation/) - Medium
```python
class Solution:
...
## Problem: [667. Beautiful Arrangement II](https://leetcode.com/problems/beautiful-arrangement-ii/) - Medium
```python
class Solution:
...
## Problem: [50. Pow(x, n)](https://leetcode.com/problems/powx-n/) - Medium
```python
class Solution:
    def myPow(self, x, n):
        if n == 0:
...
## Problem: [70. Climbing Stairs](https://leetcode.com/problems/climbing-stairs/) - Easy
```python
class Solution:
...
## Problem: [509. Fibonacci Number](https://leetcode.com/problems/fibonacci-number/) - Easy
```python
class Solution:
    def fib(self, n):
        if n <= 1:
...
## Problem: [779. K-th Symbol in Grammar](https://leetcode.com/problems/k-th-symbol-in-grammar/) - Medium
```python
class Solution:
...
## Problem: [231. Power of Two](https://leetcode.com/problems/power-of-two/) - Easy
```python
class Solution:
...
## Problem: [94. Binary Tree Inorder Traversal](https://leetcode.com/problems/binary-tree-inorder-traversal/) - Easy
```python
class Solution:
...
## Problem: [100. Same Tree](https://leetcode.com/problems/same-tree/) - Easy
```python
class Solution:
...
## Problem: [104. Maximum Depth of Binary Tree](https://leetcode.com/problems/maximum-depth-of-binary-tree/) - Easy
```python
class Solution:
...
## Problem: [226. Invert Binary Tree](https://leetcode.com/problems/invert-binary-tree/) - Easy
```python
class Solution:
...
## Problem: [236. Lowest Common Ancestor of a Binary Tree](https://leetcode.com/problems/lowest-common-ancestor-of-a-binary-tree/) - Medium
```python
class Solution:
...
## Problem: [543. Diameter of Binary Tree](https://leetcode.com/problems/diameter-of-binary-tree/) - Easy
```python
class Solution:
...
## Problem: [124. Binary Tree Maximum Path Sum](https://leetcode.com/problems/binary-tree-maximum-path-sum/) - Hard
```python
class Solution:
...
## Problem: [53. Maximum Subarray](https://leetcode.com/problems/maximum-subarray/) - Medium
```python
class Solution:
...
## Problem: [108. Convert Sorted Array to Binary Search Tree](https://leetcode.com/problems/convert-sorted-array-to-binary-search-tree/) - Easy
```python
class Solution:
...
## Problem: [148. Sort List](https://leetcode.com/problems/sort-list/) - Medium
```python
class Solution:
...
## Problem: [912. Sort an Array](https://leetcode.com/problems/sort-an-array/) - Medium
```python
class Solution:
...
## Problem: [215. Kth Largest Element in an Array](https://leetcode.com/problems/kth-largest-element-in-an-array/) - Medium
```python
class Solution:
...
## Problem: [198. House Robber](https://leetcode.com/problems/house-robber/) - Medium
```python
from functools import lru_cache
class Solution:
    def rob(self, nums):
...
## Problem: [300. Longest Increasing Subsequence](https://leetcode.com/problems/longest-increasing-subsequence/) - Medium
```python
from functools import lru_cache
class Solution:
...
## Problem: [329. Longest Increasing Path in a Matrix](https://leetcode.com/problems/longest-increasing-path-in-a-matrix/) - Hard
```python
from functools import lru_cache
class Solution:
...
## Problem: [115. Distinct Subsequences](https://leetcode.com/problems/distinct-subsequences/) - Hard
```python
from functools import lru_cache
class Solution:
...
## Problem: [315. Count of Smaller Numbers After Self](https://leetcode.com/problems/count-of-smaller-numbers-after-self/) - Hard
```python
class Solution:
...
## Problem: [493. Reverse Pairs](https://leetcode.com/problems/reverse-pairs/) - Hard
```python
class Solution:
...
## Problem: [327. Count of Range Sum](https://leetcode.com/problems/count-of-range-sum/) - Hard
```python
class Solution:
...
## Problem: [33. Search in Rotated Sorted Array](https://leetcode.com/problems/search-in-rotated-sorted-array/) - Medium
```python
class Solution:
...
## Problem: [4. Median of Two Sorted Arrays](https://leetcode.com/problems/median-of-two-sorted-arrays/) - Hard
```python
class Solution:
...
## Problem: [69. Sqrt(x)](https://leetcode.com/problems/sqrtx/) - Easy
```python
class Solution:
    def mySqrt(self, x):
...
## Problem: [105. Construct Binary Tree from Preorder and Inorder Traversal](https://leetcode.com/problems/construct-binary-tree-from-preorder-and-inorder-traversal/) - Medium
```python
class Solution:
...
## Problem: [106. Construct Binary Tree from Inorder and Postorder Traversal](https://leetcode.com/problems/construct-binary-tree-from-inorder-and-postorder-traversal/) - Medium
```python
class Solution:
...
## Problem: [654. Maximum Binary Tree](https://leetcode.com/problems/maximum-binary-tree/) - Medium
```python
class Solution:
...
## Problem: [23. Merge k Sorted Lists](https://leetcode.com/problems/merge-k-sorted-lists/) - Hard
```python
class Solution:
...
## Problem: [241. Different Ways to Add Parentheses](https://leetcode.com/problems/different-ways-to-add-parentheses/) - Medium
```python
from functools import lru_cache
class Solution:
...
## Problem: [395. Longest Substring with At Least K Repeating Characters](https://leetcode.com/problems/longest-substring-with-at-least-k-repeating-characters/) - Medium
```python
from collections import Counter
class Solution:
...
## Problem: [427. Construct Quad Tree](https://leetcode.com/problems/construct-quad-tree/) - Medium
```python
class Solution:
...
## Problem: [932. Beautiful Array](https://leetcode.com/problems/beautiful-array/) - Medium
```python
from functools import lru_cache
class Solution:
...
## Problem: [240. Search a 2D Matrix II](https://leetcode.com/problems/search-a-2d-matrix-ii/) - Medium
```python
class Solution:
...
## Problem: [889. Construct Binary Tree from Preorder and Postorder Traversal](https://leetcode.com/problems/construct-binary-tree-from-preorder-and-postorder-traversal/) - Medium
```python
class Solution:
...
## Problem: [102. Binary Tree Level Order Traversal](https://leetcode.com/problems/binary-tree-level-order-traversal/) - Medium
```python
from collections import deque
class Solution:
...
## Problem: [103. Binary Tree Zigzag Level Order Traversal](https://leetcode.com/problems/binary-tree-zigzag-level-order-traversal/) - Medium
```python
from collections import deque
class Solution:
...
## Problem: [107. Binary Tree Level Order Traversal II](https://leetcode.com/problems/binary-tree-level-order-traversal-ii/) - Medium
```python
from collections import deque
class Solution:
...
## Problem: [111. Minimum Depth of Binary Tree](https://leetcode.com/problems/minimum-depth-of-binary-tree/) - Easy
```python
from collections import deque
class Solution:
...
## Problem: [200. Number of Islands](https://leetcode.com/problems/number-of-islands/) - Medium
```python
from collections import deque
class Solution:
...
## Problem: [127. Word Ladder](https://leetcode.com/problems/word-ladder/) - Hard
```python
from collections import deque
class Solution:
...
## Problem: [752. Open the Lock](https://leetcode.com/problems/open-the-lock/) - Medium
```python
from collections import deque
class Solution:
...
## Problem: [909. Snakes and Ladders](https://leetcode.com/problems/snakes-and-ladders/) - Medium
```python
from collections import deque
class Solution:
...
## Problem: [542. 01 Matrix](https://leetcode.com/problems/01-matrix/) - Medium
```python
from collections import deque
class Solution:
...
## Problem: [1162. As Far from Land as Possible](https://leetcode.com/problems/as-far-from-land-as-possible/) - Medium
```python
from collections import deque
class Solution:
...
## Problem: [1926. Nearest Exit from Entrance in Maze](https://leetcode.com/problems/nearest-exit-from-entrance-in-maze/) - Medium
```python
from collections import deque
class Solution:
...
## Problem: [622. Design Circular Queue](https://leetcode.com/problems/design-circular-queue/) - Medium
```python
...
## Problem: [933. Number of Recent Calls](https://leetcode.com/problems/number-of-recent-calls/) - Easy
```python
from collections import deque
class RecentCounter:
    def __init__(self):
...
## Problem: [1091. Shortest Path in Binary Matrix](https://leetcode.com/problems/shortest-path-in-binary-matrix/) - Medium
```python
from collections import deque
class Solution:
...
## Problem: [116. Populating Next Right Pointers in Each Node](https://leetcode.com/problems/populating-next-right-pointers-in-each-node/) - Medium
```python
from collections import deque
class Solution:
...
## Problem: [1670. Design Front Middle Back Queue](https://leetcode.com/problems/design-front-middle-back-queue/) - Medium
```python
from collections import deque
...
## Problem: [2258. Escape the Spreading Fire](https://leetcode.com/problems/escape-the-spreading-fire/) - Hard
```python
from collections import deque
class Solution:
...
## Problem: [232. Implement Queue using Stacks](https://leetcode.com/problems/implement-queue-using-stacks/) - Easy
```python
class MyQueue:
    def __init__(self):
        self.in_stack = []
...
## Problem: [641. Design Circular Deque](https://leetcode.com/problems/design-circular-deque/) - Medium
```python
...
## Problem: [773. Sliding Puzzle](https://leetcode.com/problems/sliding-puzzle/) - Hard
```python
from collections import deque
class Solution:
...
## Problem: [815. Bus Routes](https://leetcode.com/problems/bus-routes/) - Hard
```python
...
## Problem: [934. Shortest Bridge](https://leetcode.com/problems/shortest-bridge/) - Medium
```python
from collections import deque
class Solution:
...
## Problem: [347. Top K Frequent Elements](https://leetcode.com/problems/top-k-frequent-elements/) - Medium
```python
import heapq
from collections import Counter
class Solution:
...
## Problem: [692. Top K Frequent Words](https://leetcode.com/problems/top-k-frequent-words/) - Medium
```python
from collections import Counter
class Solution:
...
## Problem: [703. Kth Largest Element in a Stream](https://leetcode.com/problems/kth-largest-element-in-a-stream/) - Easy
```python
import heapq
class KthLargest:
...
## Problem: [973. K Closest Points to Origin](https://leetcode.com/problems/k-closest-points-to-origin/) - Medium
```python
import heapq
class Solution:
...
## Problem: [1046. Last Stone Weight](https://leetcode.com/problems/last-stone-weight/) - Easy
```python
import heapq
class Solution:
...
## Problem: [378. Kth Smallest Element in a Sorted Matrix](https://leetcode.com/problems/kth-smallest-element-in-a-sorted-matrix/) - Medium
```python
import heapq
class Solution:
...
## Problem: [373. Find K Pairs with Smallest Sums](https://leetcode.com/problems/find-k-pairs-with-smallest-sums/) - Medium
```python
import heapq
class Solution:
...
## Problem: [632. Smallest Range Covering Elements from K Lists](https://leetcode.com/problems/smallest-range-covering-elements-from-k-lists/) - Hard
```python
import heapq
class Solution:
...
## Problem: [295. Find Median from Data Stream](https://leetcode.com/problems/find-median-from-data-stream/) - Hard
```python
import heapq
class MedianFinder:
    def __init__(self):
...
## Problem: [502. IPO](https://leetcode.com/problems/ipo/) - Hard
```python
import heapq
class Solution:
...
## Problem: [253. Meeting Rooms II](https://leetcode.com/problems/meeting-rooms-ii/) - Medium
```python
import heapq
class Solution:
...
## Problem: [621. Task Scheduler](https://leetcode.com/problems/task-scheduler/) - Medium
```python
import heapq
from collections import Counter
class Solution:
...
## Problem: [630. Course Schedule III](https://leetcode.com/problems/course-schedule-iii/) - Hard
```python
import heapq
class Solution:
...
## Problem: [1834. Single-Threaded CPU](https://leetcode.com/problems/single-threaded-cpu/) - Medium
```python
import heapq
class Solution:
...
## Problem: [2402. Meeting Rooms III](https://leetcode.com/problems/meeting-rooms-iii/) - Hard
```python
import heapq
class Solution:
...
## Problem: [1642. Furthest Building You Can Reach](https://leetcode.com/problems/furthest-building-you-can-reach/) - Medium
```python
import heapq
class Solution:
...
## Problem: [871. Minimum Number of Refueling Stops](https://leetcode.com/problems/minimum-number-of-refueling-stops/) - Hard
```python
import heapq
class Solution:
...
## Problem: [857. Minimum Cost to Hire K Workers](https://leetcode.com/problems/minimum-cost-to-hire-k-workers/) - Hard
```python
import heapq
class Solution:
...
## Problem: [1383. Maximum Performance of a Team](https://leetcode.com/problems/maximum-performance-of-a-team/) - Hard
```python
import heapq
class Solution:
...
## Problem: [1094. Car Pooling](https://leetcode.com/problems/car-pooling/) - Medium
```python
class Solution:
...
## Problem: [1825. Finding MK Average](https://leetcode.com/problems/finding-mk-average/) - Hard
```python
...
## Problem: [2532. Time to Cross a Bridge](https://leetcode.com/problems/time-to-cross-a-bridge/) - Hard
```python
import heapq
class Solution:
...
## Problem: [480. Sliding Window Median](https://leetcode.com/problems/sliding-window-median/) - Hard
```python
from bisect import bisect_left, insort
class Solution:
...
## Problem: [786. K-th Smallest Prime Fraction](https://leetcode.com/problems/k-th-smallest-prime-fraction/) - Medium
```python
import heapq
class Solution:
...
## Problem: [643. Maximum Average Subarray I](https://leetcode.com/problems/maximum-average-subarray-i/) - Easy
```python
class Solution:
...
## Problem: [1456. Maximum Number of Vowels in a Substring of Given Length](https://leetcode.com/problems/maximum-number-of-vowels-in-a-substring-of-given-length/) - Medium
```python
class Solution:
...
## Problem: [1343. Number of Sub-arrays of Size K and Average Greater than or Equal to Threshold](https://leetcode.com/problems/number-of-sub-arrays-of-size-k-and-average-greater-than-or-equal-to-threshold/) - Medium
```python
class Solution:
...
## Problem: [3. Longest Substring Without Repeating Characters](https://leetcode.com/problems/longest-substring-without-repeating-characters/) - Medium
```python
class Solution:
...
## Problem: [904. Fruit Into Baskets](https://leetcode.com/problems/fruit-into-baskets/) - Medium
```python
class Solution:
...
## Problem: [1004. Max Consecutive Ones III](https://leetcode.com/problems/max-consecutive-ones-iii/) - Medium
```python
class Solution:
...
## Problem: [209. Minimum Size Subarray Sum](https://leetcode.com/problems/minimum-size-subarray-sum/) - Medium
```python
class Solution:
...
## Problem: [76. Minimum Window Substring](https://leetcode.com/problems/minimum-window-substring/) - Hard
```python
from collections import Counter
class Solution:
...
## Problem: [713. Subarray Product Less Than K](https://leetcode.com/problems/subarray-product-less-than-k/) - Medium
```python
class Solution:
...
## Problem: [438. Find All Anagrams in a String](https://leetcode.com/problems/find-all-anagrams-in-a-string/) - Medium
```python
from collections import Counter
class Solution:
...
## Problem: [992. Subarrays with K Different Integers](https://leetcode.com/problems/subarrays-with-k-different-integers/) - Hard
```python
class Solution:
...
## Problem: [239. Sliding Window Maximum](https://leetcode.com/problems/sliding-window-maximum/) - Hard
```python
from collections import deque
class Solution:
...
## Problem: [1423. Maximum Points You Can Obtain from Cards](https://leetcode.com/problems/maximum-points-you-can-obtain-from-cards/) - Medium
```python
class Solution:
...
## Problem: [340. Longest Substring with At Most K Distinct Characters](https://leetcode.com/problems/longest-substring-with-at-most-k-distinct-characters/) - Medium
```python
class Solution:
...
## Problem: [1052. Grumpy Bookstore Owner](https://leetcode.com/problems/grumpy-bookstore-owner/) - Medium
```python
class Solution:
...
## Problem: [1234. Replace the Substring for Balanced String](https://leetcode.com/problems/replace-the-substring-for-balanced-string/) - Medium
```python
from collections import Counter
class Solution:
...
## Problem: [1358. Number of Substrings Containing All Three Characters](https://leetcode.com/problems/number-of-substrings-containing-all-three-characters/) - Medium
```python
class Solution:
...
## Problem: [1493. Longest Subarray of 1's After Deleting One Element](https://leetcode.com/problems/longest-subarray-of-1s-after-deleting-one-element/) - Medium
```python
class Solution:
...
## Problem: [1658. Minimum Operations to Reduce X to Zero](https://leetcode.com/problems/minimum-operations-to-reduce-x-to-zero/) - Medium
```python
class Solution:
...
## Problem: [1696. Jump Game VI](https://leetcode.com/problems/jump-game-vi/) - Medium
```python
from collections import deque
class Solution:
...
## Problem: [2024. Maximize the Confusion of an Exam](https://leetcode.com/problems/maximize-the-confusion-of-an-exam/) - Medium
```python
class Solution:
...
## Problem: [2461. Maximum Sum of Distinct Subarrays With Length K](https://leetcode.com/problems/maximum-sum-of-distinct-subarrays-with-length-k/) - Medium
```python
class Solution:
...
## Problem: [2958. Length of Longest Subarray With at Most K Frequency](https://leetcode.com/problems/length-of-longest-subarray-with-at-most-k-frequency/) - Medium
```python
class Solution:
...
## Problem: [567. Permutation in String](https://leetcode.com/problems/permutation-in-string/) - Medium
```python
from collections import Counter
class Solution:
...
## Problem: [1438. Longest Continuous Subarray With Absolute Diff Less Than or Equal to Limit](https://leetcode.com/problems/longest-continuous-subarray-with-absolute-diff-less-than-or-equal-to-limit/) - Medium
```python
from collections import deque
class Solution:
...
## Problem: [30. Substring with Concatenation of All Words](https://leetcode.com/problems/substring-with-concatenation-of-all-words/) - Hard
```python
from collections import Counter
class Solution:
...
## Problem: [159. Longest Substring with At Most Two Distinct Characters](https://leetcode.com/problems/longest-substring-with-at-most-two-distinct-characters/) - Medium
```python
class Solution:
...
## Problem: [187. Repeated DNA Sequences](https://leetcode.com/problems/repeated-dna-sequences/) - Medium
```python
class Solution:
...
## Problem: [219. Contains Duplicate II](https://leetcode.com/problems/contains-duplicate-ii/) - Easy
```python
class Solution:
...
## Problem: [220. Contains Duplicate III](https://leetcode.com/problems/contains-duplicate-iii/) - Hard
```python
class Solution:
...
## Problem: [413. Arithmetic Slices](https://leetcode.com/problems/arithmetic-slices/) - Medium
```python
class Solution:
...
## Problem: [424. Longest Repeating Character Replacement](https://leetcode.com/problems/longest-repeating-character-replacement/) - Medium
```python
class Solution:
...
## Problem: [487. Max Consecutive Ones II](https://leetcode.com/problems/max-consecutive-ones-ii/) - Medium
```python
class Solution:
...
## Problem: [20. Valid Parentheses](https://leetcode.com/problems/valid-parentheses/) - Easy
```python
class Solution:
    def isValid(self, s):
        pairs = {')': '(', ']': '[', '}': '{'}
...
## Problem: [32. Longest Valid Parentheses](https://leetcode.com/problems/longest-valid-parentheses/) - Hard
```python
class Solution:
...
## Problem: [678. Valid Parenthesis String](https://leetcode.com/problems/valid-parenthesis-string/) - Medium
```python
class Solution:
...
## Problem: [921. Minimum Add to Make Parentheses Valid](https://leetcode.com/problems/minimum-add-to-make-parentheses-valid/) - Medium
```python
class Solution:
...
## Problem: [1541. Minimum Insertions to Balance a Parentheses String](https://leetcode.com/problems/minimum-insertions-to-balance-a-parentheses-string/) - Medium
```python
class Solution:
...
## Problem: [496. Next Greater Element I](https://leetcode.com/problems/next-greater-element-i/) - Easy
```python
class Solution:
...
## Problem: [503. Next Greater Element II](https://leetcode.com/problems/next-greater-element-ii/) - Medium
```python
class Solution:
...
## Problem: [739. Daily Temperatures](https://leetcode.com/problems/daily-temperatures/) - Medium
```python
class Solution:
...
## Problem: [901. Online Stock Span](https://leetcode.com/problems/online-stock-span/) - Medium
```python
class StockSpanner:
    def __init__(self):
        self.stack = []
...
## Problem: [84. Largest Rectangle in Histogram](https://leetcode.com/problems/largest-rectangle-in-histogram/) - Hard
```python
class Solution:
...
## Problem: [85. Maximal Rectangle](https://leetcode.com/problems/maximal-rectangle/) - Hard
```python
class Solution:
...
## Problem: [907. Sum of Subarray Minimums](https://leetcode.com/problems/sum-of-subarray-minimums/) - Medium
```python
class Solution:
...
## Problem: [150. Evaluate Reverse Polish Notation](https://leetcode.com/problems/evaluate-reverse-polish-notation/) - Medium
```python
class Solution:
...
## Problem: [224. Basic Calculator](https://leetcode.com/problems/basic-calculator/) - Hard
```python
class Solution:
...
## Problem: [227. Basic Calculator II](https://leetcode.com/problems/basic-calculator-ii/) - Medium
```python
class Solution:
    def calculate(self, s):
        stack = []
...
## Problem: [394. Decode String](https://leetcode.com/problems/decode-string/) - Medium
```python
class Solution:
...
## Problem: [71. Simplify Path](https://leetcode.com/problems/simplify-path/) - Medium
```python
class Solution:
...
## Problem: [402. Remove K Digits](https://leetcode.com/problems/remove-k-digits/) - Medium
```python
class Solution:
...
## Problem: [316. Remove Duplicate Letters](https://leetcode.com/problems/remove-duplicate-letters/) - Medium
```python
class Solution:
...
## Problem: [1081. Smallest Subsequence of Distinct Characters](https://leetcode.com/problems/smallest-subsequence-of-distinct-characters/) - Medium
```python
class Solution:
...
## Problem: [456. 132 Pattern](https://leetcode.com/problems/132-pattern/) - Medium
```python
class Solution:
...
## Problem: [155. Min Stack](https://leetcode.com/problems/min-stack/) - Medium
```python
class MinStack:
    def __init__(self):
        self.stack = []
...
## Problem: [225. Implement Stack using Queues](https://leetcode.com/problems/implement-stack-using-queues/) - Easy
```python
from collections import deque
class MyStack:
    def __init__(self):
...
## Problem: [388. Longest Absolute File Path](https://leetcode.com/problems/longest-absolute-file-path/) - Medium
```python
class Solution:
...
## Problem: [636. Exclusive Time of Functions](https://leetcode.com/problems/exclusive-time-of-functions/) - Medium
```python
class Solution:
...
## Problem: [735. Asteroid Collision](https://leetcode.com/problems/asteroid-collision/) - Medium
```python
class Solution:
...
## Problem: [259. 3Sum Smaller](https://leetcode.com/problems/3sum-smaller/)
```python
class Solution:
...
## Problem: [315. Count of Smaller Numbers After Self](https://leetcode.com/problems/count-of-smaller-numbers-after-self/)
```python
class Solution:
    def countSmaller(self, nums):
        n = len(nums)
...
## Problem: [763. Partition Labels](https://leetcode.com/problems/partition-labels/)
```python
class Solution:
...
## Problem: [1329. Sort the Matrix Diagonally](https://leetcode.com/problems/sort-the-matrix-diagonally/)
```python
from collections import defaultdict
class Solution:
...
## Problem: [5. Longest Palindromic Substring](https://leetcode.com/problems/longest-palindromic-substring/) - Medium
```python
class Solution:
...
## Problem: [28. Find the Index of the First Occurrence in a String](https://leetcode.com/problems/find-the-index-of-the-first-occurrence-in-a-string/) - Easy
```python
class Solution:
...
## Problem: [61. Rotate List](https://leetcode.com/problems/rotate-list/) - Medium
```python
class Solution:
...
## Problem: [82. Remove Duplicates from Sorted List II](https://leetcode.com/problems/remove-duplicates-from-sorted-list-ii/) - Medium
```python
class Solution:
...
## Problem: [86. Partition List](https://leetcode.com/problems/partition-list/) - Medium
```python
class Solution:
...
## Problem: [143. Reorder List](https://leetcode.com/problems/reorder-list/) - Medium
```python
class Solution:
...
## Problem: [151. Reverse Words in a String](https://leetcode.com/problems/reverse-words-in-a-string/) - Medium
```python
class Solution:
...
## Problem: [160. Intersection of Two Linked Lists](https://leetcode.com/problems/intersection-of-two-linked-lists/) - Easy
```python
class Solution:
...
## Problem: [161. One Edit Distance](https://leetcode.com/problems/one-edit-distance/) - Medium
```python
class Solution:
...
## Problem: [165. Compare Version Numbers](https://leetcode.com/problems/compare-version-numbers/) - Medium
```python
class Solution:
...
## Problem: [170. Two Sum III - Data structure design](https://leetcode.com/problems/two-sum-iii-data-structure-design/) - Easy
```python
class TwoSum:
    def __init__(self):
        self.counts = {}
...
## Problem: [186. Reverse Words in a String II](https://leetcode.com/problems/reverse-words-in-a-string-ii/) - Medium
```python
class Solution:
    def reverseWords(self, s):
...
## Problem: [189. Rotate Array](https://leetcode.com/problems/rotate-array/) - Medium
```python
class Solution:
...
## Problem: [244. Shortest Word Distance II](https://leetcode.com/problems/shortest-word-distance-ii/) - Medium
```python
class WordDistance:
...
## Problem: [246. Strobogrammatic Number](https://leetcode.com/problems/strobogrammatic-number/) - Easy
```python
class Solution:
...
## Problem: [251. Flatten 2D Vector](https://leetcode.com/problems/flatten-2d-vector/) - Medium
```python
class Vector2D:
...
## Problem: [272. Closest Binary Search Tree Value II](https://leetcode.com/problems/closest-binary-search-tree-value-ii/) - Hard
```python
from collections import deque
class Solution:
...
## Problem: [277. Find the Celebrity](https://leetcode.com/problems/find-the-celebrity/) - Medium
```python
class Solution:
...
## Problem: [321. Create Maximum Number](https://leetcode.com/problems/create-maximum-number/) - Hard
```python
class Solution:
...
## Problem: [360. Sort Transformed Array](https://leetcode.com/problems/sort-transformed-array/) - Medium
```python
class Solution:
...
## Problem: [392. Is Subsequence](https://leetcode.com/problems/is-subsequence/) - Easy
```python
class Solution:
...
## Problem: [408. Valid Word Abbreviation](https://leetcode.com/problems/valid-word-abbreviation/) - Easy
```python
class Solution:
...
## Problem: [443. String Compression](https://leetcode.com/problems/string-compression/) - Medium
```python
class Solution:
...
## Problem: [455. Assign Cookies](https://leetcode.com/problems/assign-cookies/) - Easy
```python
class Solution:
...
## Problem: [457. Circular Array Loop](https://leetcode.com/problems/circular-array-loop/) - Medium
```python
class Solution:
...
## Problem: [466. Count The Repetitions](https://leetcode.com/problems/count-the-repetitions/) - Hard
```python
class Solution:
...
## Problem: [475. Heaters](https://leetcode.com/problems/heaters/) - Medium
```python
class Solution:
...
## Problem: [481. Magical String](https://leetcode.com/problems/magical-string/) - Medium
```python
class Solution:
...
## Problem: [522. Longest Uncommon Subsequence II](https://leetcode.com/problems/longest-uncommon-subsequence-ii/) - Medium
```python
class Solution:
...
## Problem: [524. Longest Word in Dictionary through Deleting](https://leetcode.com/problems/longest-word-in-dictionary-through-deleting/) - Medium
```python
class Solution:
...
## Problem: [532. K-diff Pairs in an Array](https://leetcode.com/problems/k-diff-pairs-in-an-array/) - Medium
```python
class Solution:
...
## Problem: [541. Reverse String II](https://leetcode.com/problems/reverse-string-ii/) - Easy
```python
class Solution:
...
## Problem: [556. Next Greater Element III](https://leetcode.com/problems/next-greater-element-iii/) - Medium
```python
class Solution:
...
## Problem: [557. Reverse Words in a String III](https://leetcode.com/problems/reverse-words-in-a-string-iii/) - Easy
```python
class Solution:
    def reverseWords(self, s):
        chars = list(s)
...
## Problem: [581. Shortest Unsorted Continuous Subarray](https://leetcode.com/problems/shortest-unsorted-continuous-subarray/) - Medium
```python
class Solution:
...
## Problem: [633. Sum of Square Numbers](https://leetcode.com/problems/sum-of-square-numbers/) - Medium
```python
import math
class Solution:
...
## Problem: [647. Palindromic Substrings](https://leetcode.com/problems/palindromic-substrings/) - Medium
```python
class Solution:
...
## Problem: [653. Two Sum IV - Input is a BST](https://leetcode.com/problems/two-sum-iv-input-is-a-bst/) - Easy
```python
class Solution:
...
## Problem: [658. Find K Closest Elements](https://leetcode.com/problems/find-k-closest-elements/) - Medium
```python
class Solution:
...
## Problem: [696. Count Binary Substrings](https://leetcode.com/problems/count-binary-substrings/) - Easy
```python
class Solution:
...
## Problem: [719. Find K-th Smallest Pair Distance](https://leetcode.com/problems/find-k-th-smallest-pair-distance/) - Hard
```python
class Solution:
...
## Problem: [723. Candy Crush](https://leetcode.com/problems/candy-crush/) - Medium
```python
class Solution:
...
## Problem: [777. Swap Adjacent in LR String](https://leetcode.com/problems/swap-adjacent-in-lr-string/) - Medium
```python
class Solution:
...
## Problem: [795. Number of Subarrays with Bounded Maximum](https://leetcode.com/problems/number-of-subarrays-with-bounded-maximum/) - Medium
```python
class Solution:
...
## Problem: [809. Expressive Words](https://leetcode.com/problems/expressive-words/) - Medium
```python
class Solution:
...
## Problem: [821. Shortest Distance to a Character](https://leetcode.com/problems/shortest-distance-to-a-character/) - Easy
```python
class Solution:
...
## Problem: [825. Friends Of Appropriate Ages](https://leetcode.com/problems/friends-of-appropriate-ages/) - Medium
```python
class Solution:
...
## Problem: [826. Most Profit Assigning Work](https://leetcode.com/problems/most-profit-assigning-work/) - Medium
```python
class Solution:
...
## Problem: [832. Flipping an Image](https://leetcode.com/problems/flipping-an-image/) - Easy
```python
class Solution:
...
## Problem: [838. Push Dominoes](https://leetcode.com/problems/push-dominoes/) - Medium
```python
class Solution:
...
## Problem: [844. Backspace String Compare](https://leetcode.com/problems/backspace-string-compare/) - Easy
```python
class Solution:
...
## Problem: [845. Longest Mountain in Array](https://leetcode.com/problems/longest-mountain-in-array/) - Medium
```python
class Solution:
...
## Problem: [870. Advantage Shuffle](https://leetcode.com/problems/advantage-shuffle/) - Medium
```python
class Solution:
...
## Problem: [881. Boats to Save People](https://leetcode.com/problems/boats-to-save-people/) - Medium
```python
class Solution:
...
## Problem: [905. Sort Array By Parity](https://leetcode.com/problems/sort-array-by-parity/) - Easy
```python
class Solution:
...
## Problem: [917. Reverse Only Letters](https://leetcode.com/problems/reverse-only-letters/) - Easy
```python
class Solution:
...
## Problem: [922. Sort Array By Parity II](https://leetcode.com/problems/sort-array-by-parity-ii/) - Easy
```python
class Solution:
...
## Problem: [923. 3Sum With Multiplicity](https://leetcode.com/problems/3sum-with-multiplicity/) - Medium
```python
class Solution:
...
## Problem: [925. Long Pressed Name](https://leetcode.com/problems/long-pressed-name/) - Easy
```python
class Solution:
...
## Problem: [942. DI String Match](https://leetcode.com/problems/di-string-match/) - Easy
```python
class Solution:
...
## Problem: [Matrix-Vector Dot Product](https://www.deep-ml.com/problems/1)
